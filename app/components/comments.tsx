  ...
  const comments = [
    {
      ...
      comment:
        'Our company uses Datastral, and I also use Box personally to store my documents, photos, videos, sensitive data etc. Datastral is amazing so much more than just cloud storage. You can watch videos, share photos, scan documents, electronic sign and send documents, secure sensitive data and so much more.',
    },
    {
      user: {
        name: 'Sophia Bennett',
